		...
		<h2 style="padding-left: 20px">Data Transaksi Pemesanan Pakan Ikan</h2>
			<table width="924" border="1" align="center" cellpadding="0" cellspacing="0">
				<tr bgcolor="FF6600" >
					...
					<th width="10%">Bibit Ikan</td>&nbsp;
					<th width="10%"> Ukuran</td>&nbsp;  
					<th width="10%"> Harga</td>&nbsp; 
					<th width="10%"> Jumlah/ekor</td>&nbsp;  
					<th width="25%"> Total Pembayaran</td>&nbsp;   
				</tr>
				<?php
					$sql = mysql_query("select * from transaksi order by id_transaksi asc") or die (mysql_error());
				...
				<tr align="center"  bgcolor="#EEF2F7">
					...
					<td><div align="center"><?php echo $data['bibit_ikan']; ?></div></td>
					<td><div align="center"><?php echo $data['ukuran']; ?></div></td>
			...
			<br>
			<div class="button" style="margin-left: 20px; text-align: center; padding-top: 5px; "><a href="cetaki.php" style="text-decoration: none; color: #fff;" target="new">Cetak</a></div>
	</div>
	<div id="footer">
