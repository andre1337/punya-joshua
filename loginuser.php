...
<body>
	<div class="lg-container">
		<h2 style="color: #336666"><img src="img/user-icon.png" width="100px" align="left"></h2>
		<form action="" id="lg-form" name="lg-form" method="post">
			...
			<a href="daftar.php" id="back" style="float: right;">Daftar</a>
			...
			<?php
				...
				if($login) {
					if($user == "" || $pass == "") {
						...
						$sql = mysql_query("select * from member where username = '$user' and password = '$pass'") or die (mysql_error());
